...
def render_main_tab(hist_fig,
                    ...
                    filters_summary):
    return html.Div([
        html.H4("DEM error dashboard + Floodplain (HAND) analysis", style={"marginBottom": "18px"}),
        html.Div(
        ...
        html.Div([
            html.Div([
                html.H5([
                    ...
                    html.Span("ⓘ", id="hist-help", style={"color": "#61dafb", "marginLeft": "8px", "cursor": "pointer"})
                ], style={"marginBottom": "10px", "marginLeft": "10px"}),
                dbc.Tooltip("Displayed is a random sample (max 20,000 points). For illustration only.", target="hist-help"),
                dcc.Graph(figure=hist_fig, style={"height": "240px", "width": "100%"})
            ], style={"width": "27%", "marginRight": "14px"}),

            html.Div([
                html.H5([
                    f"Boxplot of errors for {dem.upper().replace('_', ' ')}",
                    html.Span("ⓘ", id="box-help", style={"color": "#61dafb", "marginLeft": "8px", "cursor": "pointer"})
                ], style={"marginBottom": "10px", "marginLeft": "10px"}),
                dbc.Tooltip("Displayed is a random sample (max 20,000 points). For illustration only.", target="box-help"),
                dcc.Graph(figure=box_fig, style={"height": "240px", "width": "100%"})
            ], style={"width": "21%", "marginRight": "14px"}),

            html.Div([
                html.H5("DEM performance (filtered)", style={"marginBottom": "10px", "marginLeft": "10px"}),
                dcc.Graph(figure=filtered_bar, style={"height": "240px", "width": "100%"})
            ], style={"width": "48%"}),
        ], style={"display": "flex", "gap": "8px", "alignItems": "flex-start", "marginBottom": "24px"}),

        html.Div([
            html.Div([
                html.H4(filtered_table_title),
                html.P(filters_summary,
                       style={"color": "#ccc", "fontSize": "14px", "marginTop": "-8px", "marginBottom": "10px"}),
